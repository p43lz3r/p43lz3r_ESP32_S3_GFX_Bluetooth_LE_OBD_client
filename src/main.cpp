...
void setup()
{
    ...
    gfx.printAt(200, 200, "Ford Fiesta ST");
    gfx.useFreeSans9pt();
...
void drawDashboard() {
    ...
    //drawGauge(250, 100, 150, "COOLANT", dashData.coolantTemp, "°C", 70, 100, COLOR_BLUE);
    //drawGauge(450, 100, 150, "THROTTLE", dashData.throttlePos, "%", 0, 100, COLOR_GREEN);
    ...
    gfx.useFreeSans18pt7b();
    gfx.setTextColor(COLOR_WHITE);
    gfx.printAt(50, 350, "RPM:");
    gfx.setTextColor(COLOR_CYAN);
    char rpmStr[20];
    sprintf(rpmStr, "%d", dashData.rpm);
    gfx.printAt(150, 350, rpmStr);
